    ...
    article.innerHTML = `
      <div class="projet-card-inner">
        ...
        <div class="projet-card-actions">
          <a href="${projet.details}" class="btn btn-primary btn-sm" target="${projet.details !== '#' && projet.details !== 'index.html' ? '_blank' : '_self'}">
            Voir plus →
          </a>
          <a href="${projet.github}" class="btn btn-ghost btn-sm" target="_blank" aria-label="Voir le code sur GitHub">
